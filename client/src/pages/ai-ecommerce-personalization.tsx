...
const pageSchema = [
  createArticleSchema(
    ...
    "2024-10-30",
    "https://www.iscalestudio.com/blog/ai-ecommerce-personalization",
    "AI Trends"
  ),
  createBreadcrumbSchema([
    { name: "Home", url: "https://www.iscalestudio.com" },
    { name: "Blog", url: "https://www.iscalestudio.com/blog" },
    { name: "The Future of E-Commerce: AI-Powered Personalization at Scale", url: "https://www.iscalestudio.com/blog/ai-ecommerce-personalization" }
  ])
];
  ...
  return (
    <div className="min-h-screen pt-20 pb-12">
      <SEOHead
        ...
        canonical="https://www.iscalestudio.com/blog/ai-ecommerce-personalization"
        type="article"
        schema={pageSchema}
        article={{
