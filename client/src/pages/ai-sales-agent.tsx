      ...
      <section className="py-12 sm:py-16 bg-gradient-to-b from-purple-900/20 to-violet-900/10 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <Badge className="bg-gradient-to-r from-purple-500 to-pink-500 text-white border-0 mb-4">AI Sales Agent</Badge>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold mb-4">Automate Sales with AI Sales Agent</h1>
            <p className="text-base sm:text-lg text-gray-700">Close more deals faster with intelligent lead qualification, follow-ups, and deal management powered by AI conversations.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="space-y-12">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">How AI Sales Agent Works</h2>
              <p className="text-gray-700 mb-6 leading-relaxed">
                The AI Sales Agent qualifies leads automatically, engages prospects with intelligent conversations, tracks deal progress, and triggers timely follow-ups. It learns from your sales processes and improves pitch effectiveness over time.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  "Intelligent prospect engagement conversations",
                  ...
                  "Sales training and best practice recommendations"
                ].map((feature, idx) => (
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 bg-white/50 backdrop-blur-xl border border-white/40 rounded-2xl p-6">
                <div>
                  <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#9929ea] to-[#5808fb]">3x</p>
                ...
                <div>
                  <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#9929ea] to-[#5808fb]">35%</p>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Sales engagement</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700">
                <li>• B2B SaaS companies managing large pipelines</li>
                <li>• Sales teams handling high volume of leads</li>
                <li>• Enterprise sales requiring complex deal management</li>
                <li>• E-commerce businesses automating customer outreach</li>
                <li>• Agencies handling multiple client sales processes</li>
              </ul>
            </div>

            <div className="bg-gradient-to-r from-[#9929ea]/15 to-[#2DBFBA]/15 border border-[#9929ea]/40 rounded-2xl p-8 text-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Ready to transform your sales process?</h3>
              <p className="text-gray-700 mb-6">Let's deploy an AI Sales Agent that closes more deals in less time for your team.</p>
              <Link href="/booking">
