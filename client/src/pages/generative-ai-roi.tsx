...
const pageSchema = [
  createArticleSchema(
    ...
    "2024-11-20",
    "https://www.iscalestudio.com/blog/generative-ai-roi",
    "AI Trends"
  ),
  createBreadcrumbSchema([
    { name: "Home", url: "https://www.iscalestudio.com" },
    { name: "Blog", url: "https://www.iscalestudio.com/blog" },
    { name: "Generative AI in Business: From Hype to ROI", url: "https://www.iscalestudio.com/blog/generative-ai-roi" }
  ])
];
  ...
  return (
    <div className="min-h-screen pt-20 pb-12">
      <SEOHead
        ...
        canonical="https://www.iscalestudio.com/blog/generative-ai-roi"
        type="article"
        schema={pageSchema}
        article={{
