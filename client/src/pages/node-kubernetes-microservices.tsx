...
const pageSchema = [
  createArticleSchema(
    ...
    "2024-11-18",
    "https://www.iscalestudio.com/blog/node-kubernetes-microservices",
    "Tech Stack"
  ),
  createBreadcrumbSchema([
    { name: "Home", url: "https://www.iscalestudio.com" },
    { name: "Blog", url: "https://www.iscalestudio.com/blog" },
    { name: "Building Scalable Microservices with Node.js and Kubernetes", url: "https://www.iscalestudio.com/blog/node-kubernetes-microservices" }
  ])
];
  ...
  return (
    <div className="min-h-screen pt-20 pb-12">
      <SEOHead
        ...
        canonical="https://www.iscalestudio.com/blog/node-kubernetes-microservices"
        type="article"
        schema={pageSchema}
        article={{
