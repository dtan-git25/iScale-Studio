...
const pageSchema = [
  createArticleSchema(
    ...
    "2023-10-24",
    "https://www.iscalestudio.com/blog/autonomous-ai-agents-business",
    "AI Trends"
  ),
  createBreadcrumbSchema([
    { name: "Home", url: "https://www.iscalestudio.com" },
    { name: "Blog", url: "https://www.iscalestudio.com/blog" },
    { name: "The Rise of Autonomous AI Agents in Business", url: "https://www.iscalestudio.com/blog/autonomous-ai-agents-business" }
  ])
];
  ...
  return (
    <div className="min-h-screen pt-20 pb-12">
      <SEOHead
        ...
        canonical="https://www.iscalestudio.com/blog/autonomous-ai-agents-business"
        type="article"
        schema={pageSchema}
        article={{
