...
const pageSchema = [
  createArticleSchema(
    ...
    "2023-10-12",
    "https://www.iscalestudio.com/blog/streamlining-operations-n8n-openai",
    "Tutorial"
  ),
  createBreadcrumbSchema([
    { name: "Home", url: "https://www.iscalestudio.com" },
    { name: "Blog", url: "https://www.iscalestudio.com/blog" },
    { name: "Streamlining Operations with n8n and OpenAI", url: "https://www.iscalestudio.com/blog/streamlining-operations-n8n-openai" }
  ])
];
  ...
  return (
    <div className="min-h-screen pt-20 pb-12">
      <SEOHead
        ...
        canonical="https://www.iscalestudio.com/blog/streamlining-operations-n8n-openai"
        type="article"
        schema={pageSchema}
        article={{
