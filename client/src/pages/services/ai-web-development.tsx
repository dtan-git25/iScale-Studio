...
import webDevImg from "@assets/optimized_images/futuristic_web_development_concept_small.webp";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <img src={webDevImg} alt="AI Web Development" className="rounded-xl shadow-lg" width="600" height="327" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Our AI web development expertise spans across modern frameworks like React, Next.js, and Node.js. We leverage the latest AI technologies to create web applications that aren't just functional, but intelligent and adaptive.
              </p>
          ...
          >
            <h2 className="text-4xl font-bold mb-12">Why Choose Our AI Web Development?</h2>
