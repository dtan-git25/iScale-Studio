...
const pageSchema = [
  createArticleSchema(
    ...
    "2024-11-08",
    "https://www.iscalestudio.com/blog/first-ai-workflow-guide",
    "Tutorial"
  ),
  createBreadcrumbSchema([
    { name: "Home", url: "https://www.iscalestudio.com" },
    { name: "Blog", url: "https://www.iscalestudio.com/blog" },
    { name: "Building Your First AI Workflow: A Step-by-Step Guide", url: "https://www.iscalestudio.com/blog/first-ai-workflow-guide" }
  ])
];
  ...
  return (
    <div className="min-h-screen pt-20 pb-12">
      <SEOHead
        ...
        canonical="https://www.iscalestudio.com/blog/first-ai-workflow-guide"
        type="article"
        schema={pageSchema}
        article={{
