...
export default function CaseStudy5() {
  const pageSchema = [
    createWebPageSchema(
      ...
      "https://www.iscalestudio.com/portfolio/marketing-automation-workflow"
    ),
    createBreadcrumbSchema([
      { name: "Home", url: "https://www.iscalestudio.com" },
      { name: "Case Studies", url: "https://www.iscalestudio.com/case-studies" },
      { name: "Marketing Automation Workflow", url: "https://www.iscalestudio.com/portfolio/marketing-automation-workflow" }
    ])
  ];
  ...
  return (
    <>
      <SEOHead
        ...
        canonical="https://www.iscalestudio.com/portfolio/marketing-automation-workflow"
        schema={pageSchema}
      />
