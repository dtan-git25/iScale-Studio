...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      {/* Service Summary Sections */}
      <section className="py-24 md:py-32 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        <motion.div
          animate={{ x: [0, 50, -50, 0], y: [0, -30, 30, 0] }}
          transition={{ duration: 20, repeat: Infinity }}
          className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-[#9929ea]/8 to-transparent rounded-full blur-3xl pointer-events-none"
        />
        <motion.div
          animate={{ x: [0, -50, 50, 0], y: [0, 30, -30, 0] }}
          transition={{ duration: 18, repeat: Infinity }}
          className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-br from-[#2DBFBA]/8 to-transparent rounded-full blur-3xl pointer-events-none"
        />
            ...
            {[
              {
                ...
                description: "Custom web applications powered by cutting-edge AI technology to transform your digital presence.",
              ...
              {
                icon: "📱",
                title: "Build intelligent mobile apps",
                description: "Custom mobile apps powered by AI that deliver exceptional user experiences on iOS and Android.",
              ...
              },
              {
                ...
                description: "Enterprise-grade automation workflows that streamline operations and reduce repetitive work.",
              ...
              {
                icon: "🤖",
                title: "Deploy digital workforce",
                description: "Autonomous AI agents that work 24/7 to handle customer service, sales, and business operations.",
                link: "/services/ai-agents",
                gradient: "from-pink-500/20 to-rose-500/20",
                borderGradient: "from-pink-500/40 to-rose-500/40"
              },
              {
                icon: "🛍️",
                title: "Elevate your online store",
                description: "Powerful e-commerce platforms with integrated AI features to drive sales and customer engagement.",
              ...
              {
                icon: "🧠",
                title: "Build proprietary ML models",
                description: "Custom machine learning models tailored to your specific data and business needs.",
                link: "/services/ai-ml-development",
                gradient: "from-orange-500/20 to-yellow-500/20",
                borderGradient: "from-orange-500/40 to-yellow-500/40"
              }
            ].map((service, idx) => (
              <Link key={idx} href={service.link}>
                ...
                >
                  <div className={`h-full bg-gradient-to-br ${service.gradient} backdrop-blur-sm border border-white/60 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col`}>
                    ...
                    <div className="flex items-center text-[#8629e4] font-semibold mt-4 group-hover:translate-x-1 transition-transform">
