...
function TechCarousel() {
  ...
  const technologies = [
    ...
    { name: "OpenAI", icon: <Cpu className="h-10 w-10" />, color: "text-teal-600" },
    ...
    { name: "LangChain", icon: <Settings className="h-10 w-10" />, color: "text-teal-600" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="flex items-center justify-between gap-6">
            ...
            <button
              onClick={handlePrev}
              className="flex-shrink-0 p-3 rounded-lg bg-gray-100 border border-gray-300 hover:bg-gray-200 hover:border-gray-400 transition-all text-teal-600 hover:scale-110"
                ...
                {visibleTechs.map((tech, idx) => (
                  ...
                  >
                    <div className="glass-panel p-6 rounded-xl border border-gray-200 hover:border-gray-300 transition-all hover:bg-gray-100 h-full flex flex-col items-center justify-center gap-4 group cursor-pointer">
                      ...
                      <p className="text-sm font-mono text-gray-600 text-center group-hover:text-teal-600 transition-colors truncate w-full">
                        {tech.name}
                      </p>
                    </div>
                  </motion.div>
...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            >
              <div className="inline-block px-3 py-1 mb-6 rounded-full bg-lime-100 border border-lime-300 text-teal-600 text-sm font-mono">
                AI-Powered Digital Solutions
              </div>
              <h1 className="text-5xl lg:text-7xl font-display font-bold leading-tight mb-6">
                Transform Your Business with <span className="text-teal-600">AI-Powered</span> Digital Solutions
              </h1>
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <Link href="/contact">
                  <Button size="lg" className="bg-lime-500 hover:bg-teal-700 text-white border-0 rounded-full px-8 h-14 text-lg shadow-lg shadow-lime-500/25">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="glass-panel p-8 rounded-xl group border border-gray-200 hover:border-gray-300 transition-colors h-full">
                ...
                <Link href="/services">
                  <a className="inline-flex items-center text-sm font-medium text-teal-600 hover:text-teal-700">
            ...
            >
              <div className="glass-panel p-8 rounded-xl group border border-gray-200 hover:border-gray-300 transition-colors h-full">
                <div className="bg-gray-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Workflow className="h-10 w-10 text-teal-600" />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <Link href="/about">
                <Button variant="outline" className="border-teal-600 text-teal-600 hover:bg-lime-50">
            ...
            {[
              ...
              >
                <div className="glass-panel p-6 rounded-xl h-full">
                  <div className="text-4xl font-display font-bold text-teal-600/20 mb-3">{step.num}</div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              ...
              >
                <div className="glass-panel p-8 rounded-xl overflow-hidden border border-gray-200 hover:border-gray-300 transition-colors h-full">
                  <p className="text-xs text-teal-600 font-mono mb-3 uppercase tracking-widest">INDUSTRY: {study.industry}</p>
                  <h3 className="text-xl font-bold mb-4">{study.title}</h3>
                  <p className="text-muted-foreground mb-6">{study.desc}</p>
                  <div className="pt-4 border-t border-gray-200">
                    <p className="text-sm font-mono text-teal-600">{study.metric}</p>
                  </div>
                </div>
              </motion.div>
            ))}
          ...
          <div className="text-center mt-12">
            <Link href="/portfolio">
              <Button variant="outline" size="lg" className="rounded-full px-8 h-12 border-teal-600 text-teal-600 hover:bg-lime-50">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-lime-100/30 to-lime-100/30 border-y border-gray-200">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 mb-12">
            <div className="flex items-center justify-center gap-3">
              ...
              <div>
                ...
                <a href="mailto:hello@iscalestudio.com" className="font-mono text-teal-600 hover:text-teal-700">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <div>
                ...
                <a href="tel:+639560623082" className="font-mono text-teal-600 hover:text-teal-700">
                  +63 956 0623 082
                </a>
              </div>
            </div>
