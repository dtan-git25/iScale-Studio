        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl lg:text-4xl font-display font-bold mb-4">Our AI-Powered Solutions</h2>
              <p className="text-lg text-gray-700 max-w-2xl mx-auto">
                Explore our comprehensive range of AI development and automation services.
              </p>
            </motion.div>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="flex-1 space-y-6">
                  ...
                  <h3 className="text-2xl lg:text-3xl font-black text-gray-900">{service.title}</h3>
                  ...
                  {/* Key Features Box */}
                  <div className="bg-gradient-to-r from-[#9929ea]/5 via-white to-[#2DBFBA]/10 rounded-xl p-6 border border-gray-100/50">
