      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              ...
              <li><Link href="/services"><a className="hover:[#8629e4] transition-colors">E-commerce Solutions</a></Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              ...
              <li><Link href="/contact"><a className="hover:[#8629e4] transition-colors">Contact</a></Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:hello@iscalestudio.com" className="hover:[#8629e4]">hello@iscalestudio.com</a>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-5 w-5 [#8629e4] shrink-0" />
                <a href="tel:+639560623082" className="hover:[#8629e4]">+63 956 0623 082</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600">
          ...
          <div className="flex space-x-6">
            ...
            <a href="#" className="hover:[#8629e4] transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
