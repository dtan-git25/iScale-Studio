      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
              ...
              <Link key={link.name} href={link.href}>
                <a
                  className={`text-sm font-medium transition-colors hover:text-teal-600 ${
                    location === link.href ? "text-teal-600" : "text-gray-600"
                  }`}
                >
                  {link.name}
                </a>
            ...
            <Link href="/contact">
              <Button className="bg-gradient-to-r from-lime-400 to-teal-600 hover:from-lime-500 hover:to-teal-700 text-white border-0">
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="text-foreground hover:text-teal-600 focus:outline-none"
            >
