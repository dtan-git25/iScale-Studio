        ...
        >
          {step === 'datetime' ? (
            <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 lg:gap-8">
              ...
              {/* Time Slots Column - 20% */}
              <div className="lg:col-span-2">
                <p className="text-sm font-bold text-gray-900 mb-3">
                  {selectedDate ? format(selectedDate, 'MMM d') : 'Time'}
                </p>
                  ...
                  {slotsLoading ? (
                    ...
                    availableSlots.map((slot) => (
                      <button
                        ...
                        className={`w-full py-3 px-3 rounded-xl border-2 text-sm font-medium transition-all flex items-center justify-between ${
                          !slot.available
                    ...
                    <div className="text-center py-8 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
                      <p className="text-gray-500 text-xs">No slots</p>
                    </div>
                  ) : null}
                </div>
              </div>
